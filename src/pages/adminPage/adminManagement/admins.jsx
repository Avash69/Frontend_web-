        ...
        <table className="w-full  text-left table-collapse">
          ...
          <tbody>
            <tr v-for="user in newRegisteredUsers">
              <td className="p-2 border-t border-LightSecondaryColor">aeeeeeeeeeeeeeeuf</td>
              <td className="p-2 border-t border-LightSecondaryColor">akskkskskdsksks eeeee e eeeee eee</td>
